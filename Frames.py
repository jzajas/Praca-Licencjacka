...
class UrlFrame(CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        self.entry = CTkEntry(master=self, width=400, height=40, corner_radius=20, text_color="black",
                              fg_color="white", placeholder_text="URL", placeholder_text_color="black",
                              font=("Arial", 15))
...
class FileFrame(CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        self.entry = CTkEntry(master=self, width=400, height=40, corner_radius=20, text_color="black",
                              fg_color="white", placeholder_text="File Path", placeholder_text_color="black",
                              font=("Arial", 15))
        self.button = CTkButton(master=self, width=135, height=30, corner_radius=20, text_color="black",
...
class FolderFrame(CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        self.label = CTkLabel(master=self, text="Folder", width=100, height=30, anchor="e", text_color="#0080ff",
                              fg_color="transparent", font=("Arial", 20), padx=30, pady=5)
        self.entry = CTkEntry(master=self, width=400, height=40, corner_radius=20, text_color="black",
                              fg_color="white", placeholder_text="Folder Path", placeholder_text_color="black",
                              font=("Arial", 15))
